...
export const controlsPhases: PhaseControls[] = [
  {
    ...
    controls: [
      ...
      },
      {
        ...
        icon: "battery",
        source: "KEYBOARD",
        inputs: [{ type: "key", label: "Ctrl+Z" }],
        description: "Turns on the plane's electrical power and alternator.",
      },
      {
        id: "parking-brake",
  ...
  },
  {
    ...
    controls: [
      ...
      },
      {
        ...
        icon: "layers",
        source: "KEYBOARD",
        inputs: [{ type: "key", label: "V" }, { type: "key", label: "Ctrl+V" }],
        inputJoiner: "or",
  ...
  },
  {
    ...
    controls: [
      ...
      },
      {
        ...
        icon: "zap",
        source: "KEYBOARD",
        inputs: [{ type: "key", label: "Ctrl+1" }],
        description: "Let the computer help fly — great for cruising!",
      },
      {
        id: "show-efb",
        action: "Open EFB Tablet",
        icon: "tablet",
        source: "KEYBOARD",
        inputs: [{ type: "key", label: "Tab" }],
        description: "Open the cockpit tablet with maps and airport info.",
      },
    ],
    ...
    controls: [
      {
        ...
        icon: "chevrons-down",
        source: "KEYBOARD",
        inputs: [{ type: "key", label: "B" }, { type: "key", label: "Ctrl+B" }],
        inputJoiner: "or",
      ...
      },
      {
        ...
        icon: "chevrons-up",
        source: "KEYBOARD",
        inputs: [{ type: "key", label: "Ctrl+\\" }],
        description: "Arm spoilers so they pop up on landing to slow you down.",
      },
    ],
  ...
  },
  {
    ...
    controls: [
      ...
      },
      {
        ...
        source: "KEYBOARD",
        inputs: [{ type: "key", label: "Tab" }],
        description: "Check the tablet for maps and airport info.",
      },
      {
        id: "taxi-speed",
        action: "Taxi Speed",
